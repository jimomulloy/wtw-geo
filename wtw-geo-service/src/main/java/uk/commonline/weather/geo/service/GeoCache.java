...
public class GeoCache {
	...
	try {
	    ...
	    System.out.println("!!Add forepoints:" + forepoints.size());
	    for (GeoLocation forepoint : forepoints) {
		this.forepoints.add(forepoint);
		System.out.println("!!Add forepoint id:" + forepoint.id + ", name:" + forepoint.name + ", lat:" + forepoint.latitude + ", long:"
			+ forepoint.longitude);
	    }
	} finally {
	    rl.unlock();
	...
	System.out.println("!!getNearest standpoint id:" + standpoint.id + ", name:" + standpoint.name + ", lat:" + standpoint.latitude + ", long:"
	...
	try {
		...
		if (newDist < site.dist) { // is closer than we have seen before
		    ...
		    System.out.println("!!got nearer newDist:"+ newDist +", forepoint:"+ forepoint.id + ", name:" + forepoint.name + ", lat:" + forepoint.latitude
			    + ", long:" + forepoint.longitude);
